...
import com.test.util.TestListnerExtentReport;
...
public class ReportUtil {
	...
	public static File extractResultTable(String environment,String fileName) {
		...
		File file= null;
		try {
			file =new File(System.getProperty("user.dir")+System.getProperty("file.separator")+"temp.html");
			if(!file.exists())
				file.createNewFile();
			
			ArrayList<HashMap <String, HashMap <String, Integer>>> status = TestListnerExtentReport.reportStatus;
...
//		    tableRow.remove();
		    ...
		    table.prepend("<tr><td>Finished on:</td><td>"+TestListnerExtentReport.endTime+"</td></tr>");
		    table.prepend("<tr><td>Started on:</td><td>"+TestListnerExtentReport.startTime+"</td></tr>");
